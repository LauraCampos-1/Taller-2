...
let nombreRemplazo = prompt("Digite un nombre a reemplazar:");
let nuevNombre =prompt("Digite un nombre a insertar");

nombres.push(nuevNombre);
nombres [ 2 ] = nombreRemplazo;
console.log(nombres);